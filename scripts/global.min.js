...
bootstrap=function(){var a=$("body");a.prepend(function(){return navmenu+header});a.append(function(){return footer});$("#navbar-contents").hide();var b=$(".animated-icon"),c=$($("#header-links-mobile")[0]);$(".navbar-toggler").click(function(a){b.hasClass("open")?($("#navbar-contents").fadeOut(400,function(){}),c.removeClass("scroll-follow")):($("#navbar-contents").fadeIn(400,function(){}),c.addClass("scroll-follow"));b.toggleClass("open")})};$(bootstrap);
